...
from {{cookiecutter.repo_name}}.database.core import get_db
from {{cookiecutter.repo_name}}.database.services import common_parameters, search_filter_sort_paginate
from {{cookiecutter.repo_name}}.settings.service import get_all as get_settings
from {{cookiecutter.repo_name}}.settings.models import Settings
